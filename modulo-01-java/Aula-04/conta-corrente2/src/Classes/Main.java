...
public class Main {
    public static void main(String[] args) {
        ...
        cliente1.setEnderecos(new Endereco[]{endereco1, endereco2});
        cliente1.setContatos(new Contato[]{contatoPessoa1, contatoPessoa3});

        Cliente cliente2 = new Cliente();
        cliente2.setNome("Daniel de Oliveira Santos");
        cliente2.setCpf("01234567890");
        cliente2.setEnderecos(new Endereco[]{endereco1});
        cliente2.setContatos(new Contato[]{contatoPessoa1, contatoPessoa2});
