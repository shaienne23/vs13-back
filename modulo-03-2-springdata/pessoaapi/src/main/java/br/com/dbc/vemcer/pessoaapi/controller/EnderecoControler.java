...
public class EnderecoControler implements IEnderecoController {
    ...
    public ResponseEntity<List<EnderecoDTO>>findAllByIdEnderecoContains(@PathVariable("idEndereco") Integer id){
...
//    }
    ...
    public ResponseEntity<List<EnderecoDTO>> findAllByEstadoContains(@RequestParam("estado") String estado){
        ...
        List<EnderecoDTO> enderecoPorEstado = enderecoService.findAllByEstadoContains(estado);
    ...
    public ResponseEntity<EnderecoDTO> create(@PathVariable("idPessoa") //Integer idPessoa,
        ...
        EnderecoDTO enderecoCriado = enderecoService.create( endereco);//idPessoa,
